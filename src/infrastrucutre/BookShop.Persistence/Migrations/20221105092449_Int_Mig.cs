        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizationName = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasketItem_AspNetUsers_CustomerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormatsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPrices_Formats_FormatId",
                        column: x => x.FormatId,
                        principalTable: "Formats",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookPrices_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "NEWID()"),
                    DiscounAmaount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BookId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FormatId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    LanguageId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Discounts_Formats_FormatId",
                        column: x => x.FormatId,
                        principalTable: "Formats",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Discounts_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BlogImage_IsMain = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AuthorImageId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NormalizationName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "Getutcdate()"),
                    CreatedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Authors_Files_AuthorImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authors_NormalizationName",
                table: "Authors",
                column: "NormalizationName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blogs_NormalizationName",
                table: "Blogs",
                column: "NormalizationName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPrices_FormatId",
                table: "BookPrices",
                column: "FormatId");

            migrationBuilder.CreateIndex(
                name: "IX_BookPrices_LanguageId",
                table: "BookPrices",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_NormalizationName",
                table: "Books",
                column: "NormalizationName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_NormalizationName",
                table: "Categories",
                column: "NormalizationName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discounts_FormatId",
                table: "Discounts",
                column: "FormatId");

            migrationBuilder.CreateIndex(
                name: "IX_Discounts_LanguageId",
                table: "Discounts",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Files_BooksId",
                table: "Files",
                column: "BooksId");

            migrationBuilder.CreateIndex(
                name: "IX_Formats_NormalizationName",
                table: "Formats",
                column: "NormalizationName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscribe_Email",
                table: "Subscribe",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Types_NormalizationName",
                table: "Types",
                column: "NormalizationName",
                unique: true);
